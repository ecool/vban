...
using audio_backend_open_f = int(*)(audio_backend_handle_t handle, const char* output_name,
                                    const char* application_name, enum audio_direction direction, size_t buffer_size,
                                    const struct stream_config_t* config);
